...
"""
fill_tpl.py
Fills in a template (where there are curly braces) with values from a configuration file.
"""
...
from che696_examples.common import (InvalidDataError, GOOD_RET, INPUT_ERROR, warning, IO_ERROR, process_cfg, read_tpl,
...
def parse_cmdline(argv=None):
    ...
    parser = argparse.ArgumentParser(description='Fills in a template file with parameter values.')
